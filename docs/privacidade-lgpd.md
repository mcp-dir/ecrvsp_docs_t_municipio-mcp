...
ECRVSP Documentos Transferência de Município: Estado segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [ecrvsp_docs_t_municipio@mcp.ai](mailto:ecrvsp_docs_t_municipio@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
